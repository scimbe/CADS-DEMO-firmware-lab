...
| **Reichweite noch offen** | Die urspruengliche Formulierung hier - "ab der siebten gleichzeitigen Anfrage sieht der Studierende im Hoersaal einen rohen Fehler" - **ist nicht belegt** und stammt von mir. Gemessen ist: Die Grenze liegt auf der **Client-Seite** und gilt rechneruebergreifend (drei Prozesse mit je acht gleichzeitigen ergaben zusammen 6 von 24, nicht 18 von 24); die Relay-Sitzung erreicht von ihrer Seite 10 von 10, direkt und durch den Tunnel. Offen ist, ob die Grenze im Agenten-Sandkasten sitzt (dann sind Studierende nicht betroffen und dieser Absatz gehoert korrigiert) oder im Netzpfad, den auch ein Studierenden-Behaelter nimmt (dann ist es der dringendste Punkt auf der Liste). Entscheidender Test: derselbe Nebenlaeufigkeitstest **aus einem Behaelter auf dem Laborrechner**. |
