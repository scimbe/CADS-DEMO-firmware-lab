...
| **Offene Frage, entscheidbar mit einer Beobachtung** | Hielt der Kern kurz wirklich an, oder ist das Ereignis frei erfunden? Entscheidet sich daran, ob die **Firmware sichtbar weiterläuft** (Anzeige/Konsolenausgabe), während die Leiste „angehalten" zeigt. Läuft sie, hat der Kern nie angehalten. |
