...
| [PEDAGOGY-RULES.md](PEDAGOGY-RULES.md) | Binding rules for course design and tutor behaviour (German, with an English summary): step shape, honest Bloom levels, check design and the negative test, hint tiers, misconceptions, scaffolding, recall, prediction, language for the weakest reader, challenge for the strongest, and the tutor's limits. Every rule names the review finding it came from. | **Yes** – for every course pack |
| [review/round-1-firmware.md](review/round-1-firmware.md), [review/round-2-firmware.md](review/round-2-firmware.md) | Two persona reviews of the firmware course and the tutor (sceptical professor of programming methodology, strongest student, weakest student), with measurements, verbatim evidence and what was done about each finding. | Evidence |
