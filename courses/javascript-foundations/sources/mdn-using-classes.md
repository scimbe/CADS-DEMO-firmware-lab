...
> Source: MDN Web Docs, *JavaScript Guide* - [Using classes](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Using_classes), fetched
> 2026-09-03 from the `mdn/content` repository
> (`files/en-us/web/javascript/guide/using_classes/index.md`, branch `main`).
>
