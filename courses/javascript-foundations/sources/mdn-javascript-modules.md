...
> Source: MDN Web Docs, *JavaScript Guide* - [JavaScript modules](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Modules), fetched
> 2026-09-03 from the `mdn/content` repository
> (`files/en-us/web/javascript/guide/modules/index.md`, branch `main`).
>
