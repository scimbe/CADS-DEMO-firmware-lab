...
tasks:
  ...
  - id: shared-or-copied
    ...
    check: { type: question, prompt: { en: "The first test passed and the second failed on the same function. What did the copy not copy?", de: "Der erste Test bestand, der zweite scheiterte, gleiche Funktion. Was hat die Kopie nicht kopiert?" }, rubric: "Benennt, was vervielfältigt wurde und worauf nur ein zweites Mal gezeigt wurde, und sagt, warum der eine Test bestehen konnte, während der andere scheiterte. Gibt die Tiefe an, in der das Vervielfältigen aufhörte. Besteht nicht: eine vergessene Eigenschaft verantwortlich machen, oder das Wort Kopie benutzen, ohne zu sagen, was beiden gemeinsam blieb.", bloom: analyze, minChars: 50 }
socratic:
