...
tasks:
  ...
  - id: why-catch-missed
    ...
    check: { type: question, prompt: { en: "The call sat inside try and the failure still escaped. Why? Two sentences, plus what cause preserves.", de: "Der Aufruf stand im try und der Fehler entkam doch. Warum? Zwei Sätze, plus was cause bewahrt." }, rubric: "Erklärt, dass der Block fertig wird, während der Fehlschlag noch vor ihm liegt, und nennt das Schlüsselwort, das den Fehlschlag hineinholt. Sagt danach, was das ursprüngliche Objekt über seinen Satz hinaus trägt. Besteht nicht: die Behauptung, die Konstruktion sei in asynchronem Code unbrauchbar, oder die äußere Formulierung höher zu bewerten als das innere Objekt.", bloom: analyze, minChars: 60 }
socratic:
