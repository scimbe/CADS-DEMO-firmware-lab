...
tasks:
  ...
  - id: all-eight
    title: "Alle acht Tests bestehen, Panics eingeschlossen"
...
Eine Einzelheit lohnt sich zu wissen: cargo listet einen solchen Test als `test … - should panic ... ok` auf, mit der Markierung zwischen Name und Ergebnis. Dieser Step traegt deshalb einen zweiten Check, der schlicht `test result: ok. 8 passed; 0 failed` verlangt, sodass alle vier Panic-Tests abgedeckt sind, was immer ein Testlisten-Parser aus dieser Markierung macht.
