...
Führe die Host-Suite aus; sie enthält beide Golden-Szenen. Lies die Aufnahmeschleife der Galerie und den Kopf von `golden_check.py`. Beurteile dann den Fehlschlag, den die zweite Aufgabe beschreibt — er hat andere Zahlen als der Fall von 2026-08-30, das Verfahren ist dasselbe. Beantworte zuletzt, wann ein Golden neu erzeugt werden darf. Der nächste Step wendet sich vom Beweisen zum Beurteilen von Code.
