...
1. **Quelle.** Der erste Check schickt `gui/cads_splash.c` durch den C-Präprozessor und sucht das Token erst danach in der Argumentliste des Zeichenaufrufs, zwischen dem Font- und dem Farbargument. Der Präprozessor wirft Kommentare weg — ein auskommentierter Aufruf mit demselben Wort besteht ihn also nicht; nur ein Text, der wirklich gezeichnet wird.
