...
The first check requires the slot name as an argument of a `fill_rect` call — a comment does not pass it. Then comes the prediction about the staging banks.
