...
Here you see again what `m2-00` worked through. The portable call ends in a single store to a fixed address — `GPIOD->BSRR` sits at `0x40020C18` — and that store changes voltages on real legs of the package. This is memory-mapped I/O, this time not as an example but in service.
